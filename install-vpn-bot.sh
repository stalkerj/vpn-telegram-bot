...
# Версия: 3.45(c терминальным меню и автообновлением)
# ============================================
...
print_banner() {
    ...
    echo -e "${CYAN}"
    echo "╔═══════════════════════════════════════════════════════╗"
    echo "║        VPN TELEGRAM BOT INSTALLER v3.5               ║"
    echo "╚═══════════════════════════════════════════════════════╝"
    echo -e "${NC}"
    echo ""
}
...
show_completion() {
    ...
    # Показываем благодарность и QR-код для доната
    echo ""
    echo -e "${GREEN}╔═══════════════════════════════════════════════════════╗${NC}"
    echo -e "${GREEN}║                                                       ║${NC}"
    echo -e "${GREEN}║   💚 Спасибо за использование нашего бота! 💚        ║${NC}"
    echo -e "${GREEN}║                                                       ║${NC}"
    echo -e "${GREEN}╚═══════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "${CYAN}Если проект оказался полезным, вы можете:${NC}"
    echo -e "${YELLOW}☕ Поддержать разработчика донатом${NC}"
    echo ""
    ...
    if command -v qrencode &> /dev/null; then
        ...
        echo -e "${YELLOW}📱 Отсканируйте QR-код:${NC}"
    fi

    echo -e "${GREEN}🔗 https://www.tbank.ru/cf/A1Cj74Nvan6${NC}"
    echo ""
    echo -e "${CYAN}Каждый донат мотивирует на развитие проекта! ❤️${NC}"
    echo ""
    sleep 2
