...
print_banner() {
    ...
    echo "║                                                       ║"
    echo "║         Автоматическая установка v2.2                ║"
    echo "║                                                       ║"
    echo "╚═══════════════════════════════════════════════════════╝"
    echo -e "${NC}"
    echo ""
...
# Сбор данных конфигурации (ИСПРАВЛЕНО)
collect_config() {
    ...
    # Telegram Bot Token (ИСПРАВЛЕНО: убрали подстановку команд в prompt)
    while true; do
