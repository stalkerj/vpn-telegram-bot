...
menu_loop() {
    while true; do
        ...
        # Находим строку с read -p в menu.sh и добавляем перед ней наш блок
        sed -i '/read -p "➤ Выберите действие:"/e cat /tmp/donate_qr.txt' /root/vpn-bot/menu.sh
